...
interface MochaSetupOptions {
  //milliseconds to wait before considering a tests slow
  slow?: number;
  ...
  // bail on the first tests failure
  bail?: boolean;
...
declare function before(action: (client: any, done: any) => void): void;
...
declare function after(action: (client: any, done: any) => void): void;
...
declare function beforeEach(action: (client: any, done: MochaDone) => void): void;
...
declare function afterEach(action: (client: any, done: MochaDone) => void): void; //pls
...
declare namespace Mocha {
  ...
  interface ITestDefinition {
    ...
    (expectation: string, assertion?: (client: any, done: MochaDone) => void): ITest; //pls
